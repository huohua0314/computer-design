...
#
# Generated by export_simulation on Tue Apr 11 17:39:18 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './SSeg7_Dev_1.sh' script.

./SSeg7_Dev_1.sh -reset_run
...
./SSeg7_Dev_1.sh -noclean_files

For more information on the script, please type './SSeg7_Dev_1.sh -help'.
